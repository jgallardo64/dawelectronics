                ...
                <div class="card-body">
                    <form method="POST" action="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="object" type="text" class="form-control" name="producto" required autofocus>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="brand" type="text" class="form-control" name="nombre" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="model" type="text" class="form-control" name="modelo" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label for="subcategory" class="col-md-4 col-form-label text-md-right">Subcategoria</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="provider" class="form-control" id="category">
                        ...
                        <div class="form-group row">
                            <label for="category" class="col-md-4 col-form-label text-md-right">Imagen</label>
